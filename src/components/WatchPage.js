...
const WatchPage = () => {
  ...
  const channelData = useSelector((store) => store?.videos?.channelData[0]);
  ...
  return (
    channelData && (
      ...
      <div className="px-20  py-5 flex flex-col gap-4  md:w-[80%] mt-16">
        <iframe
        ...
        <div className="gap-2 flex flex-wrap">
          ...
          <div className="flex items-center justify-center ml-4 mr-48">
          ...
          <div className="flex items-center justify-center">
            <button className="bg-gray-100  rounded-s-2xl p-1 h-9 text-sm font-semibold border-r border-solid border-gray-300">
              <ThumbsUp
                className="inline-flex items-center justify-center mb-2 mr-2  hover:stroke-green-500 hover:stroke-2"
                width={20}
                strokeWidth={1}
              />
              {formatViewCount(filterData[0]?.statistics?.likeCount)}
            </button>
            <button className="bg-gray-100  rounded-e-2xl p-2 h-9 text-sm font-semibold border-r border-solid border-gray-300">
              <ThumbsDown
                width={20}
                strokeWidth={1}
                className="inline-flex items-center justify-center  mr-2  hover:stroke-red-500 hover:stroke-2"
              />
            </button>
          </div>
          <div className="flex items-center justify-center">
            <button className="ml-2 bg-gray-100  rounded-2xl p-2  text-sm    font-semibold">
              <Share2
                className="inline-flex items-center justify-center  mr-2 hover:stroke-blue-500 hover:stroke-2"
                width={20}
                strokeWidth={1.2}
              />
              Share
            ...
            <button className="ml-2  bg-gray-100  rounded-2xl p-2  text-sm    font-semibold">
              <ArrowDownToLine
                width={20}
                strokeWidth={1.2}
                className="inline-flex items-center justify-center  mr-1 hover:stroke-black hover:stroke-2"
              />
              Download
            </button>
          </div>
        ...
        <div className="flex">
          <h1 className="text-black text-[1.32rem] px-1 mt-3 font-bold">
            {convertToNumber(filterData[0]?.statistics?.commentCount)} Comments
          </h1>
        </div>
        <CommentsContainer />
      </div>
