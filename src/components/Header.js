...
import vibeTube from "../utils/icons/vibeTube.png"
...
const Header = () => {
  ...
  >
    ...
    <div className="flex w-full justify-start items-center md:-translate-x-20">
      <input
        type="text"
        className="w-[80%] md:w-[60%] p-[8px] pr-10 text-black outline-blue-500 rounded-s-3xl bg-white placeholder:pl-2 placeholder:text-black border-2 border-solid border-gray-200 sm:visible"
        value={searchQuery}
      ...
      {searchQuery && (
        <button
          className="absolute inline-flex w-[3%] invisible md:visible top-0 right-0 md:left-[56%] mt-2 mr-2 text-gray-500 bg-transparent"
      ...
      >
        <Search className="block m-auto stroke-[1]" color="black" StrokeWidth={true} />
      </button>
    </div>
  
    {showSuggestions && (
      <div className="z-20 fixed inline-flex items-center justify-start top-[61px] border-2 border-solid border-gray-100 rounded-lg left-[5%] md:left-[20%] bg-white py-2 px-5 w-[90%] md:w-[35%] shadow-2xl">
