...
const SideBar = () => {
  ...
  return (
    <div
      className={`flex flex-col w-[250px] p-4 top-14 fixed left-0 h-full shadow-xl overflow-y-auto bg-gray-50 transition-all duration-300 transform sm:relative sm:w-[250px] lg:w-[250px] ${
        isMenuOpen
          ? "translate-x-0"
          : "translate-x-[-250px]"
      } lg:translate-x-0`} 
